<template>
  <div>
    <NuxtLink to="/characters" class="inline-flex items-center gap-2 font-semibold text-slate-600 hover:text-slate-900 mb-6">
      Back to characters
    </NuxtLink>
      ...
      <template #default v-if="data">
        ...
        <section class="mt-10">
          ...
          <ol class="divide-y rounded-xl border overflow-y-auto max-h-[600px] bg-white shadow-sm">
            <li
              v-for="episode in data.character.episode"
              :key="episode.id"
